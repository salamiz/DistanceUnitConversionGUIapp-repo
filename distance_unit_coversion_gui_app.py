...
radio_button = Radiobutton(text='Kilometre', value=1, variable=radio_variable)
radio_button.grid(row=1,column=0,padx=5,pady=5)
tooltip.bind_widget(radio_button, msg='Click to convert to Kilometres')
radio_button1 = Radiobutton(text='Miles', value=2, variable=radio_variable)
radio_button1.grid(row=1,column=1,padx=5,pady=5)
tooltip.bind_widget(radio_button1, msg='Click to convert to Miles')
